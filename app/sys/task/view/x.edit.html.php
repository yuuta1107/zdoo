        ...
        <div class="modal-content">
          <table class='table-form'>
            ...
            <tr>
              ...
              <td><?php echo html::input("teamEstimate[]", $member->estimate, "class='form-control text-center' placeholder='{$lang->task->hour}'")?></td>
              <td><?php echo html::input("teamConsumed[]", $member->consumed, "class='form-control text-center' placeholder='{$lang->task->hour}'")?></td>
              <td><?php echo html::input("teamLeft[]", $member->left, "class='form-control text-center' placeholder='{$lang->task->hour}'")?></td>
              <td>
                <a href='javascript:;' class='btn btn-mini btn-move-up'><i class='icon-arrow-up'></i></a>
                <a href='javascript:;' class='btn btn-mini btn-move-down'><i class='icon-arrow-down'></i></a>
              </td>
            </tr>
            <?php endforeach;?>
            <?php for($i = 0; $i < 3; $i++):?>
            <tr>
              ...
              <td><?php echo html::input("teamEstimate[]", '', "class='form-control text-center' placeholder='{$lang->task->hour}'")?></td>
              <td><?php echo html::input("teamConsumed[]", '', "class='form-control text-center' placeholder='{$lang->task->hour}'")?></td>
              <td><?php echo html::input("teamLeft[]", '', "class='form-control text-center' placeholder='{$lang->task->hour}'")?></td>
              <td>
                <a href='javascript:;' class='btn btn-mini btn-move-up'><i class='icon-arrow-up'></i></a>
                <a href='javascript:;' class='btn btn-mini btn-move-down'><i class='icon-arrow-down'></i></a>
              </td>
