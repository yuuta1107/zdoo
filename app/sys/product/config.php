...
$config->product->search['params']['name']          = array('operator' => '=',  'control' => 'input',  'values' => '');
$config->product->search['params']['code']          = array('operator' => '=',  'control' => 'input',  'values' => '');
...
$config->product->search['params']['desc']          = array('operator' => '=',  'control' => 'input',  'values' => '');
