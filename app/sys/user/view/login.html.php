...
if($config->checkVersion and isset($_SERVER['https']))  js::import("https://{$lang->apiUrl}/updater-latest-{$config->version}.html");
if($config->checkVersion and !isset($_SERVER['https'])) js::import("http://{$lang->apiUrl}/updater-latest-{$config->version}.html");
