...
if(!define('DT_MONTHTIME2')) define('DT_MONTHTIME2', 'n月d日 H:i');
if(!define('DT_DATE1'))      define('DT_DATE1',      'Y-m-d');
if(!define('DT_DATE2'))      define('DT_DATE2',      'Ymd');
if(!define('DT_DATE3'))      define('DT_DATE3',      'Y年m月d日');
if(!define('DT_DATE4'))      define('DT_DATE4',      'n月j日');
if(!define('DT_DATE5'))      define('DT_DATE5',      'Y年m月');
