...
EOT;
    ...
    public function signIn($account = '', $date = '')
    {
        ...
        if(($this->config->attend->signInClient == 'pc' && $viewType != 'html') or ($this->config->attend->signInClient == 'mobile' && $viewType != 'mhtml')) 
        {
        ...
        $client = $viewType == 'html' ? 'pc' : ($viewType == 'mhtml' ? 'mobile' : '');
