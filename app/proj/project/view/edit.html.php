...
<form method='post' id='editForm' action='<?php echo inlink('edit', "projectID={$project->id}")?>' class='form'>
  <table class='table-form'>
    ...
    <tr>
      ...
      <td class='whitelistTD' colspan='2'><?php echo html::checkbox('whitelist', $groups, $project->whitelist);?></td>
    </tr>
