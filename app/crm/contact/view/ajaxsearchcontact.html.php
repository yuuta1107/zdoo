<?php
/**
 * The search contact view file of contact module of RanZhi.
 *
...
#contactSearchInput {padding-left: 30px;}
...
<div class='searchInput '>
  <?php echo html::input('contactSearchInput', $key, "class='form-control' placeholder='{$lang->contact->searchInput}'");?>
  <?php echo html::hidden('contacts', $contacts);?>
  <i class='icon icon-search'></i>
</div>
<ul id='searchResult'></ul>
<script>
var lastSearchFn  = false;
var $searchInput  = $('#contactSearchInput');
...
$searchInput.on('paste change keyup', function()
{
    ...
    lastSearchFn = setTimeout(function()
    {
        ...
        if(key && key != $searchInput.data('lastkey'))
        {
            ...
            var link = createLink('crm.contact', 'ajaxGetPairs', 'key=' + key);
